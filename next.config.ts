...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/programs", destination: "/spokedu", permanent: true },
      ...
      { source: "/monthly", destination: "/spokedu/records", permanent: true },
      { source: "/insights", destination: "/spokedu/about", permanent: true },
      { source: "/parents", destination: "/spokedu/private", permanent: true },
      { source: "/institutions", destination: "/spokedu/dispatch", permanent: true },
      { source: "/audience", destination: "/spokedu", permanent: true },
      { source: "/spokedu/programs/paps", destination: "/spokedu/dispatch", permanent: true },
      { source: "/spokedu/programs/camp", destination: "/spokedu/dispatch", permanent: true },
      { source: "/spokedu/programs/oneday-event", destination: "/spokedu/dispatch", permanent: true },
      { source: "/spokedu/programs/monthly-newsports", destination: "/spokedu/dispatch", permanent: true },
      { source: "/spokedu/monthly", destination: "/spokedu/records", permanent: true },
      { source: "/spokedu/monthly/:path*", destination: "/spokedu/records", permanent: true },
      { source: "/spokedu/insights", destination: "/spokedu/about", permanent: true },
      { source: "/spokedu/programs", destination: "/spokedu/programs/spomove", permanent: true },
