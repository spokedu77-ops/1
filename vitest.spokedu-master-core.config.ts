...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'app/lib/server/spokeduMasterBillingMode.test.ts',
      ...
      'app/api/spokedu-master/payment/billing/upgrade-quote/route.test.ts',
      'app/lib/server/spokeduMasterProration.test.ts',
      'app/spokedu-master/payment/billingUi.contract.test.ts',
      'app/spokedu-master/profile/subscriptionSummary.test.ts',
      ...
      'app/spokedu-master/lib/sessionIntegrity.contract.test.ts',
      'app/spokedu-master/lib/sessionIntegrity.test.ts',
      ...
      'app/spokedu-master/activity/premiumMemoryRecovery.contract.test.ts',
      'app/spokedu-master/students/studentCreateSubmit.test.ts',
      'app/api/spokedu-master/operational-data/deleteOperationalSessions.contract.test.ts',
