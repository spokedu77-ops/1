...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-5 py-3 sm:gap-4 sm:px-8 sm:py-4">
      ...
      <div className="mx-auto w-full max-w-6xl overflow-x-auto px-5 pb-2.5 sm:px-8 md:hidden">
