...
const emphasisClass = {
  hero: 'rounded-[2.125rem] p-3 shadow-[0_34px_90px_rgba(15,33,70,0.22)] sm:p-4 lg:min-h-[34rem] lg:p-[1.125rem]',
...
export function ProductVisualFrame({
  ...
  return (
    <figure
      className={`group flex flex-col border border-white/80 bg-white/90 backdrop-blur-xl transition duration-300 motion-reduce:transform-none motion-reduce:transition-none [@media(hover:hover)_and_(pointer:fine)]:hover:-translate-y-1 [@media(hover:hover)_and_(pointer:fine)]:hover:shadow-[0_38px_96px_rgba(15,33,70,0.24)] ${emphasisClass[emphasis]} ${className}`}
    >
      ...
      <div className={`relative flex-1 overflow-hidden rounded-[0.875rem] border border-[#DFE6F1] bg-[#F5F8FF] ${aspectClassName}`}>
