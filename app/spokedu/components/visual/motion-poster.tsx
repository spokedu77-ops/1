...
const variantClass: Record<NonNullable<MotionPosterProps['variant']>, string> = {
  cinematic:
    'relative h-[min(42vw,220px)] w-full overflow-hidden rounded-[1.25rem] border border-slate-300/70 shadow-2xl shadow-indigo-950/20 sm:h-[min(48vw,300px)] sm:rounded-[1.75rem] lg:h-[min(68vh,600px)] lg:rounded-[2rem]',
