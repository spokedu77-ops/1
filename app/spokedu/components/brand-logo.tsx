...
export function BrandLogo({
  ...
  return (
    <Link
      ...
      className={`inline-flex items-center bg-transparent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#245DFF] ${className}`}
