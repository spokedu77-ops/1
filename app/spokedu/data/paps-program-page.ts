...
export const papsProgramPage = {
  ...
  overview: {
    title: 'PAPS란',
    body: '학교 체력평가 요소를 기반으로 아이들이 부담 없이 체력 요소를 경험하고, 자신의 움직임과 체력 상태를 이해하도록 돕는 놀이형 프로그램입니다. 기록보다 참여, 반복, 움직임 이해가 먼저입니다.',
  ...
  audience: {
    ...
    operations:
      '학교·방과후·기관 정규수업, 체력 요소 경험 특강, 방학 프로그램 안에서 운영할 수 있습니다.',
  },
  finalCta: {
