...
export const dispatchPage = {
  ...
  partnerReviews: {
    ...
    items: [
      {
        quote: '느린 학습자도 함께 참여할 수 있는 수업 구성',
        body: '수준별 난이도와 참여 순서를 나눠 통합반에서도 모두가 활동에 이어질 수 있도록 맞춰 주십니다.',
        name: '센터 담당자',
        org: '찾아가는 동행 체육교실',
        accent: 'violet',
      },
      {
        quote: '재미에만 머무르지 않고, 회차마다 목표가 분명한 수업입니다.',
        body: '연간 커리큘럼 안에서 회차별 활동 목적이 분명해 기관 운영 계획과 맞추기 쉽습니다.',
        name: '센터 담당자',
        org: '양천거점형키움센터',
        accent: 'sky',
      },
      {
        quote: '공간과 인원에 맞게 수업 흐름을 잘 맞춰 주셨습니다.',
        body: '좁은 공간·변동 인원에도 대기와 활동 동선이 흐트러지지 않도록 현장 조정을 해 주십니다.',
        name: '담당자',
        org: '강동구 보건소 연계 수업',
        accent: 'lime',
      },
  ...
  examples: {
    ...
    items: [
      ...
      },
      {
        ...
        review: '사진에만 머무르지 않고, 회차마다 활동 목적이 분명한 수업이었습니다.',
