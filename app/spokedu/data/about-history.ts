  ...
  periods: [
    {
      ...
      label: '2026',
      milestones: [
        { date: '2026. 01~', text: '키움센터 거점 2~7호 늘봄·돌봄 수업 출강', highlight: true },
        { date: '2026. 01~', text: '샘물, 청담, 누리봄 등 다수 지역아동센터 정기수업 출강' },
        { date: '2026. 01~', text: '압구정, 순복음, 새하늘교회 등 다수 교회 아동 대상 정기수업 출강' },
        { date: '2026. 04', text: '저소득·조손가구·비만 등 취약·영양불균형 아동 대상 건강한 성장 프로그램' },
        {
          date: '2026. 04~',
          text: '창동, 중곡, 상계종합사회복지관 등 다수 발달지연·느린학습자 대상 특수체육 수업 출강',
          highlight: true,
        },
        { date: '2026. 05', text: '서대문구 어린이날 기념 아동청소년축제 부스 운영' },
        { date: '2026. 05~', text: "중구청 지원사업: '찾동체' 특수아동 체육수업", highlight: true },
        { date: '2026. 06', text: '나비에로 장소 협업 — 톰포드 기업 원데이 체육행사 진행' },
        {
          date: '2026. 07. 16',
          text: '광주광역시 체육 지도자 교육 세미나 (스포키듀 / 스포키듀LAB)',
          highlight: true,
        },
      ],
    },
    {
      ...
      milestones: [
        ...
        {
          date: '2025. 10~11',
          text: "오산시 하나울 복지센터 느린학습자 '꿈자람스쿨' 아동 체육 수업",
          highlight: true,
        },
        {
          date: '2025. 10~11',
          text: '부천 상록학교 느려도 괜찮아 — 특수 아동 대상 특강 체육 프로그램',
          highlight: true,
        },
      ],
    },
