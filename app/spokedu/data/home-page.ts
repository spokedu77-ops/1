...
export const homePage = {
  hero: {
    id: 'hero',
    lines: ['아이와 현장에 맞는', '체육교육을 설계합니다.'] as const,
    support:
      '개인·소그룹 수업부터 기관 프로그램, SPOMOVE와 지도자 교육까지 직접 설계하고 운영합니다.',
  ...
  proofStrip: {
    id: 'proof',
    title: '현장의 경험을 교육의 기준으로 만듭니다',
    lead: '현장 수업에서 출발해 대상·공간·목적에 맞게 설계하고, 운영 경험을 SPOMOVE·수업안·지도자 교육으로 표준화합니다.',
    items: ['현장', '설계', '운영', '표준화'] as const,
    processLabel: 'FIELD → SYSTEM',
    processLine: '현장 → 설계 → 운영 → 표준화' as const,
  },
  audienceGate: {
    id: 'paths',
    title: '어떤 수업이 필요하신가요?',
    ...
    items: [
      {
        ...
        badge: '기관 담당자용',
        title: '기관 정규·행사 수업',
        description: '공간·인원·일정에 맞춰 정규수업, 행사, 방학 프로그램과 SPOMOVE 도입까지 구성합니다.',
        fit: '정기 수업, 행사, 방학 프로그램을 외부 강사와 안정적으로 운영해야 할 때',
        bullets: ['정규수업', '원데이·행사', '방학 프로그램', 'SPOMOVE 도입'] as const,
        ctaLabel: '기관 운영안 보기',
        href: `${SPOKEDU_BASE_PATH}/dispatch`,
      ...
      },
      {
        ...
        bullets: ['1:1', '소그룹', '종목 준비', '기초 움직임'] as const,
        ctaLabel: '개인수업 보기',
        href: `${SPOKEDU_BASE_PATH}/private`,
      ...
      },
      {
        ...
        bullets: ['수업안·매뉴얼', '지도자 교육', 'SPOMOVE 도입 교육', '라이선싱·MASTER'] as const,
        ctaLabel: '교육·콘텐츠 보기',
        href: `${SPOKEDU_BASE_PATH}/curriculum`,
