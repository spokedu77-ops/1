...
export const SPOKEDU_IMAGES = {
  ...
  home: {
    ...
    fieldEditorialCaseGeneral: defineImage(
      ...
      '매동초등학교 늘봄 스포츠 — 스틱과 콘을 쓰는 단체 체육수업',
      { allowedPages: ['home', 'records'] },
    ),
    fieldEditorialCaseAdapted: defineImage(
      'home',
      'home-case-adapted',
      'field-editorial/home-case-adapted-p05.webp',
      '찾아가는 동행 체육교실 — 지도자와 아동이 화면과 매트 위에서 활동하는 장면',
      { allowedPages: ['home', 'records'] },
    ),
    fieldEditorialCaseSpomove: defineImage(
      'home',
      'home-case-spomove',
      'field-editorial/home-case-spomove-p05.webp',
      '동작 키움센터 SPOMOVE 수업 — 화면을 보고 참여하는 아동들',
