...
export const monthlyRecords: MonthlyRecord[] = [
  {
    ...
    images: [
      ...
      {
        src: SPOKEDU_IMAGES.records.yangcheon.src,
  ...
  },
  {
    ...
    images: [
      {
        src: SPOKEDU_IMAGES.records.playz.src,
        alt: 'PLAYZ Lounge 방학캠프 활동 장면',
        title: 'PLAYZ Lounge 방학캠프',
      },
      {
        src: SPOKEDU_IMAGES.records.seodaemun.src,
  ...
  },
  {
    ...
    images: [
      {
        src: SPOKEDU_IMAGES.curriculum.instructorTraining.src,
        alt: '강사 교육 세션 운영 장면',
        title: '강사 교육 세션',
      },
      {
        src: SPOKEDU_IMAGES.curriculum.lessonPlan.src,
