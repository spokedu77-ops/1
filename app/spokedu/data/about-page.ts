...
export const aboutPage = {
  hero: {
    ...
    subtitle:
      '스포키듀는 아이들의 움직임을 교육적으로 설계하고, 현장에서 검증한 수업을 커리큘럼과 콘텐츠로 확장합니다.',
  },
  /** home-lab-energy.jpg */
  ...
  whatWeDo: {
    cards: [
      {
        title: '아이에게는 수업',
        description: '개인·소그룹 체육수업으로 움직임 자신감과 기본 신체기능을 만듭니다.',
      ...
      {
        title: '기관에는 프로그램',
        description: '정규수업, 원데이 행사, 방학캠프, SPOMOVE, PAPS를 기관 상황에 맞춰 제안합니다.',
      ...
      {
        title: '선생님에게는 커리큘럼',
        description: '현장 수업을 수업안, 운영 매뉴얼, 교구 활용 콘텐츠, 강사 교육으로 정리합니다.',
  ...
  method: {
    ...
    cards: [
      ...
      },
      {
        code: 'TOGETHER',
        title: '함께 움직이는 힘',
        description: '규칙과 협력을 몸으로 경험하는 사회적 자신감을 키웁니다.',
      },
    ] satisfies AboutMethodCard[],
  },
  fieldBrand: {
    title: '현장에서 검증하고, 기록으로 남기고, 커리큘럼으로 정리합니다',
    cards: [
      {
        title: '스포키듀 LAB',
