...
export const recordsPage = {
  ...
  proofSummary: [
    { label: '스포키듀 LAB', mediaKey: 'proofLab' },
    { label: '개인·소그룹 수업', mediaKey: 'trackPrivate' },
    { label: '기관 파견 수업', mediaKey: 'trackDispatch' },
    { label: '원데이 체육행사', mediaKey: 'programOneday' },
    { label: '방학캠프', mediaKey: 'programCamp' },
    { label: '월간 스포키듀 기록', mediaKey: 'proofMonthly' },
    { label: '커리큘럼 콘텐츠화', mediaKey: 'programCurriculum' },
