...
export const programRegistry: ProgramRegistryItem[] = [
  ...
  },
  {
    ...
    inquiryHref: dispatchInquiryHref({ program: 'paps' }),
    listCtaLabel: '자세히 보기',
  ...
  },
  {
    ...
    inquiryHref: dispatchInquiryHref({ program: 'monthly-newsports' }),
    listCtaLabel: '자세히 보기',
  ...
  },
  {
    ...
    hasDetailPage: false,
    detailHref: privateInquiryHref({}),
    inquiryHref: privateInquiryHref({}),
    listCtaLabel: '문의하기',
  ...
  },
  {
    ...
    inquiryHref: dispatchInquiryHref({ program: 'oneday-event' }),
    listCtaLabel: '자세히 보기',
  ...
  },
  {
    ...
    inquiryHref: dispatchInquiryHref({ program: 'camp' }),
    listCtaLabel: '자세히 보기',
