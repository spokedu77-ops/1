    ...
    <div className="space-y-14">
      <section className="rounded-3xl border border-sky-100 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-6 text-slate-100 sm:p-10">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/spokedu/contact?type=dispatch" className="rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-slate-900">
            기관 수업 제안 요청
          </Link>
          <Link href="/spokedu/contact?type=dispatch" className="rounded-full border border-slate-500 px-5 py-2.5 text-sm font-semibold text-white">
            제안서 문의하기
          </Link>
        </div>
        <div className="mt-5">
      ...
      <section className="space-y-7">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link href="/spokedu/contact?type=dispatch" className="rounded-full bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white">
            기관 수업 제안 요청
          </Link>
          <Link href="/spokedu/contact?type=dispatch" className="rounded-full border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-900">
            제안서 문의하기
          </Link>
        </div>
      </section>
