  ...
  return (
    ...
    >
      <div className="flex items-baseline gap-2">
        <span className="text-[12px] font-black uppercase tracking-[0.18em]" style={{ color: '#94a3b8' }}>
          SPOKEDU
        </span>
        <span className="text-[15px] font-black" style={{ fontFamily: 'var(--spm-font-display)', color: '#0f172a' }}>
          MASTER
        </span>
      </div>
