  ...
  return (
    <div className="sticky top-0 z-40 flex h-14 shrink-0 items-center justify-between border-b px-[22px] sm:px-8 lg:px-10" style={{ background: 'rgba(7,7,12,0.9)', backdropFilter: 'blur(22px)', borderColor: 'var(--spm-br)' }}>
      <div className="min-w-0">
        <span className="block text-[11px] font-black uppercase tracking-[0.16em]" style={{ color: 'var(--spm-t3)' }}>SPOKEDU MASTER</span>
        <span className="hidden text-[12px] font-semibold sm:block" style={{ color: 'var(--spm-t2)' }}>프로그램 라이브러리 기반 구독 운영 콘솔</span>
      </div>
      <div className="flex items-center gap-2">
        ...
        <Link href="/spokedu-master/profile" className="grid h-9 w-9 place-items-center rounded-[12px]" style={{ background: 'var(--spm-s2)', border: '1px solid var(--spm-br2)' }} aria-label="알림">
