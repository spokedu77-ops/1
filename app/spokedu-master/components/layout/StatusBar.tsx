...
export function StatusBar() {
  ...
  return (
    <div className="sticky top-0 z-40 flex h-14 shrink-0 items-center justify-between border-b px-[22px] sm:px-8 lg:px-10" style={{ background: 'rgba(255,255,255,0.88)', backdropFilter: 'blur(22px)', borderColor: '#e2e8f0' }}>
      <div className="flex items-baseline gap-2">
        <span className="text-[12px] font-black uppercase tracking-[0.18em]" style={{ color: '#94a3b8' }}>SPOKEDU</span>
        <span className="text-[15px] font-black" style={{ fontFamily: 'var(--spm-font-display)', color: '#0f172a' }}>MASTER</span>
      </div>
      <div className="flex items-center gap-2">
        ...
        <Link href="/spokedu-master/dashboard" className="relative grid h-11 w-11 place-items-center rounded-[12px]" style={{ background: '#ffffff', border: '1px solid #e2e8f0', boxShadow: '0 8px 20px rgba(15,23,42,0.04)' }} aria-label="알림">
