...
export function DesktopRail() {
  ...
  return (
    <aside className="hidden w-[184px] shrink-0 border-r px-3 py-5 lg:block" style={{ borderColor: 'var(--spm-br2)', background: 'rgba(7,7,12,0.62)' }} aria-label="SPOKEDU MASTER 데스크톱 메뉴">
