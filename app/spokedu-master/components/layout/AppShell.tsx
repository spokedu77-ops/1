...
function FloatingTimerPill() {
  ...
  return (
    <div className="flex shrink-0 justify-center px-4 pb-2">
      <div className="flex items-center gap-3 rounded-full px-4 py-2.5" style={{ background: 'rgba(12,12,18,0.96)', border: '1px solid var(--spm-br2)', boxShadow: '0 4px 20px rgba(0,0,0,0.4)' }}>
        ...
        <button type="button" onClick={() => { timerReset(); setDisplayMs(0); }} className="grid h-5 w-5 place-items-center rounded-full text-[11px] font-black" style={{ background: 'var(--spm-s3)', color: 'var(--spm-t3)' }} aria-label="타이머 초기화">
          ↺
        </button>
      </div>
    </div>
...
function OperationsBanner() {
  ...
  if (expired) {
    return (
      <div className="mx-[22px] mt-3 flex items-center justify-between gap-3 rounded-[12px] px-3 py-2 sm:mx-8 lg:mx-10" style={{ background: 'rgba(239,68,68,0.12)', border: '1px solid rgba(239,68,68,0.25)' }} role="status">
  ...
  return (
    <div className="mx-[22px] mt-3 rounded-[12px] px-3 py-2 text-[12px] font-bold sm:mx-8 lg:mx-10" style={{ background: 'rgba(245,158,11,0.12)', color: 'var(--spm-amb)', border: '1px solid rgba(245,158,11,0.25)' }} role="status">
