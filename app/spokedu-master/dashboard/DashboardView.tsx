  ...
  return (
    <section className="rounded-[20px] border border-[color:var(--spm-br2)] bg-[var(--spm-s1)] p-4 shadow-[0_8px_24px_rgba(15,23,42,0.04)] sm:p-5">
      ...
      <Link
        ...
        href={item.href}
        className="flex min-h-[82px] items-center gap-3 rounded-[14px] border border-[color:var(--spm-br)] bg-[var(--spm-s2)] px-3 py-2 transition-colors hover:border-[color-mix(in_srgb,var(--spm-acc)_35%,transparent)] hover:bg-[var(--spm-acc-glow)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--spm-acc)]"
      >
            ...
            {contextTabsToDisplay.map((tab) => {
              ...
              return (
                <button
                  ...
                  className="inline-flex min-h-11 items-center rounded-full px-4 text-[13px] font-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--spm-acc)]"
                  style={{
                    background: active ? 'var(--spm-acc)' : '#ffffff',
                    color: active ? '#ffffff' : '#475569',
                    border: active ? '1px solid var(--spm-acc)' : '1px solid #e2e8f0',
                  }}
                >
                  {tab.label}
                </button>
