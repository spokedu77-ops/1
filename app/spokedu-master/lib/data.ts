...
export const PROGRAMS: Program[] = [
  {
    ...
    tags: ['경쟁형', '민첩성', '순발력', '거리 판단', '타이밍', 'SPOMOVE 연계'],
    ...
    lessonDetail: {
      ...
      rules: [
        '목표물은 공으로 제한하고, 사람의 얼굴·목·몸통은 공격 대상에서 제외합니다.',
  ...
  },
  {
    ...
    duration: 15,
    space: '좁은 공간',
    description: '마커콘을 8자 패턴으로 통과하며 방향 전환, 감속, 재출발 리듬을 연습하는 SPOMOVE 연계 수업입니다.',
    ...
    lessonDetail: {
      ...
      developmentFocus: '민첩성 / 시각 신호 반응 / 신체 협응',
      ...
      fieldTips: ['마커콘 간격은 처음 1.5m로 시작하고 익숙해지면 2m까지 늘립니다.'],
      variations: ['저학년은 걷기-빠른 걷기-달리기 순서로 올립니다.'],
      safetyNotes: ['출발 간격을 충분히 두고, 같은 방향으로만 회전하게 안내합니다.'],
      relatedSpomoveIds: ['SR-05', 'SR-06'],
      briefingNotes: ['SPOMOVE 신호를 언제 연결할지 먼저 정합니다.'],
      rules: ['8자 동선을 익힙니다.', '화면 신호에 맞춰 이동 방향을 바꿉니다.', '라운드 후 멈춤 자세를 확인합니다.'],
  ...
  },
  {
    ...
    lessonDetail: {
      ...
      parentNote: '오늘은 팀 릴레이를 통해 출발력과 협동성을 함께 연습했습니다.',
      fieldTips: ['팀 간 실력 차이가 크면 이동 거리를 다르게 둡니다.'],
      variations: ['바통 대신 색상 카드 전달로 바꿀 수 있습니다.'],
      safetyNotes: ['반환점에서는 속도를 줄이도록 표시 콘을 둡니다.'],
      relatedSpomoveIds: ['RS-05'],
      briefingNotes: ['팀별 역할과 교대 규칙을 먼저 안내합니다.'],
      rules: ['팀별 출발선을 정합니다.', '신호에 맞춰 이동 후 교대합니다.', '라운드 후 팀 피드백을 나눕니다.'],
