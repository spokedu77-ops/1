...
const OFFICIAL_SPOMOVE_CORE_LIBRARY: OfficialSpomovePreset[] = [
  ...
  // COLOR TRACKER (level 9)
  {
    ...
    description: '흰 공을 끝까지 추적한 뒤 빨·노·초·파 구역 중 어디에 멈췄는지 맞추는 시지각 반응 활동. 단계 1/2/3은 세션에서 고릅니다.',
    cueSeconds: 3,
    rounds: 5,
    bgmAutoPlay: true,
    bgmCategory: 'spomove-training',
