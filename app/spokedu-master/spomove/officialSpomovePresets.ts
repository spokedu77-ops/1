...
const OFFICIAL_SPOMOVE_CORE_LIBRARY: OfficialSpomovePreset[] = [
  ...
  // sortOrder 32: CAMOUFLAGE (level 4)
  {
    ...
    description: '매직 아이 L1. 노이즈 속에 위장된 색 사물(과일 등)이 중앙에 드러날 때 해당 색을 찾는 시지각 반응 활동',
    cueSeconds: 3,
    rounds: 20,
    bgmAutoPlay: true,
    bgmCategory: 'spomove-training',
    ...
    isReady: true,
    settingSummary: '3초 · 20회 · BGM 자동',
    settingChips: ['매직 아이 L1', '20회', 'BGM 자동'],
    executionFacts: [
      { label: '자극 방식', value: '매직 아이 L1' },
  ...
  // sortOrder 33: MOLE (level 7)
  {
    ...
    description: '화면 곳곳 구멍에서 튀어나오는 두더지 자극에 빠르게 반응하는 시지각 반응 L1',
    cueSeconds: 3,
    rounds: 20,
    bgmAutoPlay: true,
    bgmCategory: 'spomove-training',
    ...
    isReady: true,
    settingSummary: '3초 · 20회 · BGM 자동',
    settingChips: ['두더지 L1', '20회', 'BGM 자동'],
    executionFacts: [
  ...
  // sortOrder 35: NUMBER CART (level 9)
  {
    ...
    settingChips: ['숫자 기차 L2', '5라운드', 'BGM 자동'],
    executionFacts: [
  ...
  // sortOrder 36: COLOR TRACKER (level 10)
  {
    ...
    settingChips: ['흰 공 L2', '5라운드', 'BGM 자동'],
    executionFacts: [
