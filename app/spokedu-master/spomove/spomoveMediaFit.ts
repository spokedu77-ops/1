 ...
 *
 * IMAGE thumbnails (Home/Hub cards): 4:3 frame, object-contain, object-center.
...
export const SPOMOVE_IMAGE_THUMB_OBJECT_FIT = 'contain' as const;
export const SPOMOVE_IMAGE_THUMB_ASPECT_CLASS = 'aspect-[4/3]' as const;
