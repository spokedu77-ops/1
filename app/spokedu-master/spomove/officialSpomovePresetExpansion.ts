...
function buildEngineGapPresets(startSortOrder: number): OfficialSpomovePreset[] {
  ...
  return [
    ...
    next({
      id: 'visual-reaction-camouflage-variant-exp',
      title: '시지각 반응 · Camouflage 변형 배치',
      axis: 'response',
      axisTitle: SPOMOVE_AXIS_META.response.title,
      programGroup: 'visual-reaction',
      programTitle: '시지각 반응',
      salesCopy: SPOMOVE_AXIS_META.response.salesCopy,
      engine: { mode: 'reactTrain', level: 4, camouflagePlacement: 'variant' },
      description: '숨은 도형이 중앙 고정이 아니라 극단 위치로 순환하며 나타나는 시지각 반응 변형 활동',
      cueSeconds: 3,
      rounds: 20,
      bgmAutoPlay: true,
      bgmCategory: 'spomove-training',
      recommendedUse: '시각 탐색, 주변시 반응, 위치 전환',
      isReady: true,
      settingSummary: '3초 · Camouflage 변형 배치 · BGM 자동',
      settingChips: ['Camouflage', '변형 배치', '20회', 'BGM 자동'],
      executionFacts: [
        { label: '자극 방식', value: 'Camouflage 변형 배치' },
        { label: '반복', value: '20회' },
        { label: 'BGM', value: '자동 재생' },
        { label: '효과음', value: '자동' },
      ],
    ...
    next({
      id: 'visual-reaction-mole-variant-exp',
      title: '시지각 반응 · Mole 변형',
      axis: 'response',
      axisTitle: SPOMOVE_AXIS_META.response.title,
      programGroup: 'visual-reaction',
      programTitle: '시지각 반응',
      salesCopy: SPOMOVE_AXIS_META.response.salesCopy,
      engine: { mode: 'reactTrain', level: 7, moleLookMode: 'variant' },
      description: '기본 두더지 외형에 변형 외형과 2마리 동시 출현이 섞이는 시지각 반응 활동',
      cueSeconds: 3,
      rounds: 20,
      bgmAutoPlay: true,
      bgmCategory: 'spomove-training',
      recommendedUse: '시각 탐색, 동시 자극 반응, 빠른 선택',
      isReady: true,
      settingSummary: '3초 · Mole 변형 · BGM 자동',
      settingChips: ['Mole', '변형', '20회', 'BGM 자동'],
      executionFacts: [
        { label: '자극 방식', value: 'Mole 변형' },
        { label: '반복', value: '20회' },
        { label: 'BGM', value: '자동 재생' },
        { label: '효과음', value: '자동' },
      ],
    ...
    next({
      id: 'visual-reaction-color-tracker-dual-exp',
      title: '시지각 반응 · 흰 공 2패널',
      axis: 'response',
      axisTitle: SPOMOVE_AXIS_META.response.title,
      programGroup: 'visual-reaction',
      programTitle: '시지각 반응',
      salesCopy: SPOMOVE_AXIS_META.response.salesCopy,
      engine: { mode: 'reactTrain', level: 10, colorTrackerTier: 2, colorTrackerDualPanel: true },
      description: '좌우 두 패널에서 흰 공을 동시에 기억하고 추적하는 Color Tracker 양손 모드 활동',
      cueSeconds: 3,
      rounds: 5,
      bgmAutoPlay: true,
      bgmCategory: 'spomove-training',
      recommendedUse: '시각 추적, 양측 주의, 작업기억',
      isReady: true,
      settingSummary: '흰 공 L2 · 2패널 · 5라운드 · BGM 자동',
      settingChips: ['흰 공 L2', '2패널', '5라운드', 'BGM 자동'],
      executionFacts: [
        { label: '자극 방식', value: 'Color Tracker 2패널' },
        { label: '라운드', value: '5라운드' },
        { label: 'BGM', value: '자동 재생' },
        { label: '효과음', value: '자동' },
      ],
    ...
    next({
      ...
      programGroup: 'dive',
      programTitle: 'DIVE',
      engine: { mode: 'flow', level: 1, flowFeatures: ['kick'] },
      description: 'DIVE 1단계에서 점프 흐름에 롤링 배럴 킥 장애물을 추가한 전신 반응 활동',
      salesCopy: '점프와 킥을 번갈아 처리하는 DIVE 반응 훈련',
      cueSeconds: 3,
      rounds: 1,
      bgmAutoPlay: true,
      bgmCategory: 'spomove-training',
      recommendedUse: '하체 반응, 전신 협응, DIVE 킥 장애물',
      isReady: true,
      settingSummary: 'DIVE 1단계 · 킥 · 25초 · BGM 자동',
      settingChips: ['킥', 'DIVE', '25초', 'BGM 자동'],
      executionFacts: [
        { label: '동작', value: '킥' },
        { label: '진행 방식', value: 'DIVE 1단계' },
        { label: 'BGM', value: '자동 재생' },
        { label: '효과음', value: '자동' },
      ],
    }),
...
export const OFFICIAL_SPOMOVE_EXPANSION_COUNT = 40;
