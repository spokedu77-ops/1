...
function buildEngineGapPresets(startSortOrder: number): OfficialSpomovePreset[] {
  ...
  return [
    ...
    next({
      ...
      programTitle: '시지각 반응',
      salesCopy: SPOMOVE_AXIS_META.response.salesCopy,
      engine: { mode: 'reactTrain', level: 7, handFootDifficulty: 'easy' },
    ...
    next({
      ...
      programTitle: '시지각 반응',
      salesCopy: SPOMOVE_AXIS_META.response.salesCopy,
      engine: { mode: 'reactTrain', level: 7, handFootDifficulty: 'normal' },
    ...
    next({
      ...
      programTitle: '시지각 반응',
      salesCopy: SPOMOVE_AXIS_META.response.salesCopy,
      engine: { mode: 'reactTrain', level: 7, handFootDifficulty: 'hard' },
