...
function buildEngineGapPresets(startSortOrder: number): OfficialSpomovePreset[] {
  ...
  return [
    ...
    next({
      id: 'visual-reaction-camouflage-l2',
      title: '시지각 반응 · 매직 아이 L2',
      axis: 'response',
      axisTitle: SPOMOVE_AXIS_META.response.title,
      programGroup: 'visual-reaction',
      programTitle: '시지각 반응',
      ...
      description: '매직 아이 L2. 숨은 도형이 중앙 고정이 아니라 극단 위치로 순환하며 나타나는 시지각 반응 활동',
      cueSeconds: 3,
      rounds: 20,
      bgmAutoPlay: true,
      bgmCategory: 'spomove-training',
      ...
      isReady: true,
      settingSummary: '3초 · 매직 아이 L2 · 20회 · BGM 자동',
      settingChips: ['매직 아이 L2', '20회', 'BGM 자동'],
      executionFacts: [
        { label: '자극 방식', value: '매직 아이 L2' },
        { label: '반복', value: '20회' },
        { label: 'BGM', value: '자동 재생' },
        { label: '효과음', value: '자동' },
      ],
    ...
    next({
      id: 'visual-reaction-mole-l2',
      title: '시지각 반응 · 두더지 잡기 L2',
      axis: 'response',
      axisTitle: SPOMOVE_AXIS_META.response.title,
      programGroup: 'visual-reaction',
      programTitle: '시지각 반응',
      ...
      description: '변형 외형·2마리 동시 출현이 섞이는 두더지 잡기 L2 시지각 반응 활동',
      cueSeconds: 3,
      rounds: 20,
      bgmAutoPlay: true,
      bgmCategory: 'spomove-training',
      ...
      isReady: true,
      settingSummary: '3초 · 두더지 L2 · 20회 · BGM 자동',
      settingChips: ['두더지 L2', '20회', 'BGM 자동'],
      executionFacts: [
        { label: '자극 방식', value: '두더지 L2' },
        { label: '반복', value: '20회' },
        { label: 'BGM', value: '자동 재생' },
        { label: '효과음', value: '자동' },
      ],
    ...
    next({
      id: 'flanker-mixed-size-number-exp',
      title: '플랭커 · Mixed Size · 숫자',
      en: 'Flanker',
      axis: 'attention',
      axisTitle: SPOMOVE_AXIS_META.attention.title,
      programGroup: 'flanker',
      programTitle: '플랭커',
      salesCopy: SPOMOVE_AXIS_META.attention.salesCopy,
      engine: { mode: 'flanker', level: 4, flankerStimulusType: 'number' },
      description: '크기·색이 섞인 원 자극에서 가운데 숫자에 맞는 색 위치로 반응하는 숫자 플랭커 활동',
      cueSeconds: 3,
      rounds: 20,
      bgmAutoPlay: true,
      bgmCategory: 'spomove-training',
      recommendedUse: '숫자·색 매칭, 크기 방해 억제, 선택주의',
      isReady: true,
      settingSummary: '3초 · Mixed Size · 숫자 · 20회',
      settingChips: ['Mixed Size', '숫자', '20회', 'BGM 자동'],
      executionFacts: [
        { label: '자극 방식', value: 'Mixed Size · 숫자' },
        { label: '반복', value: '20회' },
        { label: 'BGM', value: '자동 재생' },
        { label: '효과음', value: '자동' },
      ],
    ...
    next({
      ...
      programTitle: '플랭커',
      salesCopy: SPOMOVE_AXIS_META.attention.salesCopy,
      engine: { mode: 'flanker', level: 6, flankerStimulusType: 'number' },
      description: '다섯 원 크기가 다를 때 가운데 숫자에 맞는 색 위치로 반응하는 숫자 플랭커 활동',
      cueSeconds: 3,
      rounds: 20,
      bgmAutoPlay: true,
      bgmCategory: 'spomove-training',
      ...
      isReady: true,
      settingSummary: '3초 · 5 Circle · 숫자 · 20회',
      settingChips: ['5 Circle', '숫자', '20회', 'BGM 자동'],
      executionFacts: [
        { label: '자극 방식', value: '5 Circle · 숫자' },
        { label: '반복', value: '20회' },
        { label: 'BGM', value: '자동 재생' },
        { label: '효과음', value: '자동' },
      ],
