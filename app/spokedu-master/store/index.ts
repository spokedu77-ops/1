...
const defaultNotifications: Notification[] = [
  {
    id: 'n1',
    type: 'program',
    title: '오늘의 추천 수업이 라이브러리에 있습니다.',
    body: '요일에 맞춘 오늘 추천 수업안을 확인하고 "계획 추가"로 바로 등록하세요.',
  ...
  },
  {
    id: 'n2',
    type: 'report',
    title: 'SPOMOVE를 수업 전에 먼저 실행해 보세요.',
    body: '화면 신호를 보고 반응하는 3분 집중 전환 활동입니다. 큰 화면·모바일 모두 지원합니다.',
  ...
  },
  {
    ...
    body: '전체 수업안, SPOMOVE 무제한, 수업 설명 도구를 제한 없이 사용하세요. 체험 후 Pro 또는 Center 플랜으로 이어갈 수 있습니다.',
