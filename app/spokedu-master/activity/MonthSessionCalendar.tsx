...
export function MonthSessionCalendar({ month, selectedDay, sessions, action, onMonthChange, onDaySelect }: {
  ...
  return <section data-manage-calendar aria-label="월간 수업 일정" className="overflow-hidden rounded-[16px] border border-slate-200 bg-white lg:flex lg:min-h-0 lg:flex-1 lg:flex-col">
    <div className="flex min-h-14 shrink-0 flex-wrap items-center justify-between gap-2 px-3 py-1.5 sm:px-4">
      ...
      <div className="flex items-center justify-end gap-3"><div className="flex items-center">
    ...
    <div data-manage-cal-grid className={`grid min-h-0 grid-cols-7 border-t border-slate-100 lg:flex-1 ${visibleDays.length === 35 ? 'grid-rows-5' : 'grid-rows-6'}`}>
