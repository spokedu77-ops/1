...
export const metadata: Metadata = {
  ...
  keywords: ['체육교육', '유아체육', 'SPOMOVE', '수업 자료', '체육 강사', '스포츠 교육', '반응 훈련'],
  ...
  openGraph: {
    ...
    description: '수업 자료, SPOMOVE, 수업 기록과 안내문 흐름을 제공하는 체육교육 수업 운영 서비스입니다.',
    images: [{ url: '/api/spokedu-master/og', width: 1200, height: 630, alt: 'SPOKEDU MASTER' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'SPOKEDU MASTER',
    description: '체육 수업 자료와 SPOMOVE, 수업 기록과 안내문 흐름을 제공하는 SPOKEDU MASTER 서비스',
