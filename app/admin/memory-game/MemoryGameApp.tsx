...
import { EclipseReactionTraining } from './components/EclipseReactionTraining';
...
export default function MemoryGameApp({
  ...
  if (screen === 'home') {
    ...
    return (
      <div style={{ minHeight: '100vh', background: '#080C14', fontFamily: "'Pretendard','Apple SD Gothic Neo','Noto Sans KR',sans-serif", color: '#fff', display: 'flex', flexDirection: 'column', position: 'relative', overflowX: 'hidden', overflowY: 'auto' }}>
        <style>{CSS}</style>
