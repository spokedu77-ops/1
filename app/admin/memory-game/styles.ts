...
export const S: Record<string, CSSProperties> = {
  ...
  tag: { fontSize: 'clamp(1rem,3.5vw,1.4rem)', fontWeight: 700, color: '#F97316', letterSpacing: '0.1em', marginTop: '0.5rem', textAlign: 'center' },
  desc: { fontSize: 'clamp(0.88rem,2.3vw,1.05rem)', color: 'var(--text-muted)', marginTop: '1rem', lineHeight: 1.8, fontWeight: 500, textAlign: 'center' },
  ...
  csub: { color: 'var(--text-muted)', fontWeight: 500, marginBottom: '1.6rem', fontSize: '0.93rem', lineHeight: 1.6 },
  back: { background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontSize: '0.88rem', fontWeight: 600, padding: '0.2rem 0', fontFamily: 'inherit' },
  btn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', padding: '1rem 1.6rem', borderRadius: '1rem', border: 'none', cursor: 'pointer', fontSize: 'clamp(0.93rem,2.7vw,1.08rem)', fontWeight: 700, transition: 'opacity 0.12s, transform 0.12s', fontFamily: 'inherit' },
  ...
  slabel: { fontSize: '0.93rem', fontWeight: 800, color: 'var(--text)', marginBottom: '0.75rem' },
};
