...
export default function MemoryGameApp({
  ...
  const simonMixedVariantLevel = settings.mode === 'simon' && settings.level === 4;
    ...
    (cfg: Settings = settings) => {
      ...
      if (cfg.mode === 'flow') {
        ...
        const screenWarmupSec =
          nextScreen === 'visualReaction' || (cfg.mode === 'simon' && cfg.level === 3) ? 0 : warmupSec;
  ...
  if (screen === 'training') {
    ...
    if (settings.mode === 'simon' && settings.level === 3) {
      const safeReactSpeedSec = settings.kidsSafeMode
        ? Math.min(6, settings.speed * 1.25)
        : settings.speed;
