...
export const AGE_BANDS: AgeBand[] = [
  { title: "미취학 (6-7세)", focus: "운동 습관 시작과 안전한 수업 적응" },
  { title: "초등 저학년 (1-3학년)", focus: "규칙 이해, 반응·협응 향상, 팀 활동 시작" },
  { title: "초등 고학년 (4-6학년)", focus: "자기조절과 멀티스포츠 적용 확장" },
];
