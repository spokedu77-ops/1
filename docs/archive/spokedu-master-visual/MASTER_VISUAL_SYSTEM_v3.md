# ARCHIVE — Visual Foundation v3 (historical)

**Authority:** none. Do not implement from this file.

Superseded. Current Visual SSOT: `app/spokedu-master/MASTER_VISUAL_SYSTEM.md` (2026-09-06). The 2026-09-05 Art Direction file is a pointer only.

The following is the last in-repo v3 text, kept for history.
