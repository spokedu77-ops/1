/**
 * 과외 수업용 설정 (CONFIG.center.name만 '과외 수업'으로 사용)
 */
const CONFIG = Object.freeze({
  center: {
    name: "과외 수업",
    tagline: "단일 센터 운영 · 학원형 수강료 · 상담 기반 등록",
    address: "서울 ○○구 ○○로 ○○ (○○빌딩 2F)",
...
const SLIDES_DATA = [
  { src: null, svgTheme: { col1: "#C8F34A", col2: "#8BE9FF" }, title: "공간/안전", heading: "안전 동선 · 공간 구성", body: "활동 구역/대기 구역 분리 · 정원 운영 · 규범 루틴", subtitle: "안전 동선 · 정원 운영 · 규범 루틴", note: "수업 환경" },
  ...
  { src: null, svgTheme: { col1: "#FFC75A", col2: "#8BE9FF" }, title: "멀티스포츠", heading: "게임 기반 멀티스포츠", body: "규칙 이해 · 역할 수행 · 협동/커뮤니케이션", subtitle: "종목 '경험'이 아니라 '역량'으로 남게", note: "게임 기반" },
  ...
  { src: null, svgTheme: { col1: "#8BE9FF", col2: "#C8F34A" }, title: "리포트", heading: "성장 리포트(샘플)", body: "관찰 → 기준표 → 다음 목표", subtitle: "설명 가능한 운영(학원 신뢰의 핵심)", note: "분기 리포트" },
  { src: null, svgTheme: { col1: "#C8F34A", col2: "#8BE9FF" }, title: "코칭", heading: "피드백은 '동작'이 아니라 '학습'이다", body: "관찰 → 짧은 피드백 → 재시도 → 정리", subtitle: "아이의 '재시도'를 설계", note: "코칭 방식" },
];
