...
with required(table_name, column_name) as (
  values
    ...
    ('spokedu_master_subscriptions', 'next_billing_at'),
    ('spokedu_master_subscriptions', 'cancel_at_period_end'),
    ('spokedu_master_subscriptions', 'provider_billing_key_secret_id'),
    ('spokedu_master_subscriptions', 'pending_billing_key_secret_id'),
    ('spokedu_master_subscriptions', 'current_amount'),
    ('spokedu_master_subscriptions', 'renewal_retry_count'),
    ('spokedu_master_subscriptions', 'last_billing_error'),
    ('spokedu_master_subscriptions', 'next_retry_at'),
    ('spokedu_master_payment_orders', 'order_id'),
    ('spokedu_master_payment_orders', 'user_id'),
    ('spokedu_master_payment_orders', 'payment_key'),
    ('spokedu_master_payment_orders', 'billing_cycle_key'),
    ('spokedu_master_payment_webhook_events', 'event_key'),
    ('spokedu_master_payment_webhook_events', 'event_type'),
    ('spokedu_master_billing_runs', 'status'),
    ('spokedu_master_billing_runs', 'attempted'),
    ('spokedu_master_billing_runs', 'succeeded'),
    ('spokedu_master_billing_runs', 'failed'),
    ('spokedu_master_billing_runs', 'skipped'),
    ('spokedu_master_billing_runs', 'error_code'),
