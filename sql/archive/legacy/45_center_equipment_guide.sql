...
CREATE POLICY "center_equipment_guide_admin_all" ON center_equipment_guide
  FOR ALL TO authenticated
  USING (is_admin())
  WITH CHECK (is_admin());

DROP POLICY IF EXISTS "center_equipment_guide_select_authenticated" ON center_equipment_guide;
CREATE POLICY "center_equipment_guide_select_authenticated" ON center_equipment_guide
