-- save_scenario is a SECURITY DEFINER helper function. The app codebase does not call it via RPC.
-- Prevent signed-in users from invoking it via PostgREST (/rest/v1/rpc/save_scenario).
--
