-- SECURITY DEFINER maintenance function should not be executable by signed-in users.
-- Keep EXECUTE only for trusted server roles (service_role / supabase_admin).
--
...
BEGIN
  FOR r IN
    ...
    WHERE n.nspname = 'public'
      AND p.proname = 'spokedu_pro_purge_stripe_webhook_events'
  LOOP
