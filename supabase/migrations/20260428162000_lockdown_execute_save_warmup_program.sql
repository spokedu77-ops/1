-- save_warmup_program is a SECURITY DEFINER RPC that was granted to anon/authenticated.
-- The app codebase does not call this RPC directly, so prevent signed-in users from invoking it via PostgREST.
--
...
BEGIN
  FOR r IN
    ...
    WHERE n.nspname = 'public'
      AND p.proname = 'save_warmup_program'
  LOOP
