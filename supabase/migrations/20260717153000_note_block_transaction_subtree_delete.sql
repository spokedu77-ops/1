-- Admin Note delete contract: soft-deleting a block soft-deletes its active subtree.
-- This prevents invisible orphan children when callers pass only the root id.
