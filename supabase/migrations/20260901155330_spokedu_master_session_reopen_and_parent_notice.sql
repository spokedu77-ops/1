-- Completed sessions can be reopened without deleting their attendance, activity
-- completion, memo, or notice. Reopening only changes lifecycle timestamps.
alter table public.spokedu_master_sessions
  add column if not exists parent_notice text;
